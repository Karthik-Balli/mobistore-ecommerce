    ...
    <div className='flex min-h-screen mt-7'>
      <div className='w-full max-w-3xl mx-auto flex flex-col lg:flex-row p-3'>
        <div>
          ...
          <div>
            <h2 className='w-max text-3xl sm:text-4xl lg:text-5xl font-bold mb-4 sm:mb-6 bg-violet-500 border-2 border-[#C68EFD] rounded-xl bg-clip-text text-transparent p-2'>
              {isSignUp ? 'Sign Up' : 'Sign In'}
            </h2>

            <p className='text-base sm:text-lg lg:text-xl text-gray-400 mb-6 sm:mb-8'>
              {isSignUp
                ? 'Join MobiStore today and discover exclusive deals on your favorite products!'
                : 'Welcome back to MobiStore! Log in to continue your shopping journey.'}
            </p>
          </div>
          {/* Toggle form */}
